...
enum Operations : uint8_t
{
    ...
    iInc = 7,       // - Инкремент
    iDec = 8,       // - Декремент
    iLAnd = 9,      // - Логическое И
    iLOr = 10,      // - Логическое ИЛИ
    iLNot = 11,     // - Логическое НЕ
    ...
    iIO = 16,       // - Ввод/вывод целых чисел
    rIO = 17,       // - Ввод/вывод вещественных чисел
...
public:
    ...
    Registers regs[4];      // - Регистры общего назначения
